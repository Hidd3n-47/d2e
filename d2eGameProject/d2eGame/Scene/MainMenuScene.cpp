...
{
    const d2e::spriteId joinSpriteId = d2e::SpriteManager::Instance()->LoadTexture("Assets/Join.png");
    const d2e::spriteId exitSpriteId = d2e::SpriteManager::Instance()->LoadTexture("Assets/Exit.png");
